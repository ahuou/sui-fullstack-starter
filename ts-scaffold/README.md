## Sui move ts implementation testing :) 

This is a simple Node project with Typescript you should use to test your implementations with your own tests. 

This scaffold can:

- read and validate the .env variables using [dotenv](https://www.npmjs.com/package/dotenv), [env-cmd](https://www.npmjs.com/package/env-cmd) and [zod](https://zod.dev/)
- run tests with [Jest](https://jestjs.io/)
- communicate with the Sui blockchain using [@mysten/sui](https://www.npmjs.com/package/@mysten/sui)
