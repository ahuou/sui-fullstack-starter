...
import type { ProtocolConfig, SuiClient } from '.pnpm/@mysten+sui.js@0.54.1_typescript@5.8.3/node_modules/@mysten/sui.js/client';
import type { SignatureWithBytes, Signer } from '.pnpm/@mysten+sui.js@0.54.1_typescript@5.8.3/node_modules/@mysten/sui.js/cryptography';
...
export declare class TransactionBlock {
    ...
    get blockData(): {
        ...
        transactions: ({
            ...
            kind: "MakeMoveVec";
            type: {
                Some: import(".pnpm/@mysten+sui.js@0.54.1_typescript@5.8.3/node_modules/@mysten/sui.js/bcs").TypeTag;
            } | {
                None: true | null;
            };
            objects: ({
